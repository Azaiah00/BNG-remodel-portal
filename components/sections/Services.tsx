...
const services = [
  {
    ...
    icon: Instagram,
    description: "Feed posts, Reels, and Stories designed to showcase BNG Remodel's kitchen and bathroom transformations across Nashville and Middle Tennessee.",
    features: [
      "Before/after project imagery",
      "Reels for kitchen & bathroom remodels",
      "Stories with CTAs for free quotes",
      "Captions with Nashville/Middle TN focus",
    ],
  },
  {
    id: "facebook",
    ...
    icon: Facebook,
    description: "Targeted ad creatives and organic posts that reach homeowners in Nashville, Franklin, Brentwood, and surrounding areas.",
    features: [
  ...
  },
  {
    ...
    title: "Video Ads",
    icon: Video,
    description: "Short-form video ads for social platforms. Showcase craftsmanship, before/after transformations, and the BNG Remodel difference.",
    features: [
    ...
    >
      ...
      <footer className="py-8 sm:py-12 border-t border-zinc-900 text-center">
        <p className="text-zinc-500 text-xs sm:text-sm uppercase tracking-widest font-mono">
          This portal was prepared for BNG Remodel by <span className="text-zinc-400 font-semibold">Couture House Co.</span>
        </p>
      </footer>
    </section>
  );
