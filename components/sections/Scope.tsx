...
const deliverables = [
  ...
  },
  {
    icon: PenLine,
    title: "Captions & Copy",
    desc: "AI-assisted captions, hashtags, and CTAs like 'Get a free quote' for Nashville/Middle TN.",
  },
  {
    icon: LayoutGrid,
    title: "Ad Creatives",
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
        {deliverables.map((item, index) => (
          ...
          >
            <div className="w-12 h-12 flex items-center justify-center mb-6 border border-zinc-800 bg-[#1e3a5f] transition-colors group-hover:border-[var(--color-bng-red)]">
              <item.icon
